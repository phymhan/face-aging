...
class FaceAgingEmbeddingModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(dataset_mode='faceaging_embedding')
        ...
        parser.add_argument('--cnn_relu_slope_E', type=float, default=0.8, help='slope of LeakyReLU for SiameseNetwork.cnn module')
